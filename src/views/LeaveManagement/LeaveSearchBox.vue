<template>
    <v-card>
        <v-card-title>
          <span class="headline">Leave Filter</span>
        </v-card-title>
        <v-card-text>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" flat @click.native="newFormdialog = false" @click="saveOrCloseClicked()">Apply</v-btn>
        </v-card-actions>
      </v-card>
</template>
...
export default class LeaveSearchBox extends Vue {
